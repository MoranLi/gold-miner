.data
	...
	mid_p1:			.word 0x100002bc		# First row of gold created
	mid_p2:			.word 0x1000053c		# Second row of gold created
	mid_p3:			.word 0x100007bc		# Third row of gold created
	mid_p4:			.word 0x10000a3c		# Fourth row of gold created
	mid_p5:			.word 0x10000cbc		# Fifth row of gold created
	explo_right1:		.word 0x100003f4		# First row of explosive placed
	explo_right2:		.word 0x10000974		# Second row of explosive placed
	explo_right3:		.word 0x10000bf8		# Third row of explosive placed
	explo_right4:		.word 0x10000e44		# Fourth row of explosive placed
