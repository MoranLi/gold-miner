.data
	...
	mid_p1:			.word 0x100003c0		# First row of gold created
	mid_p2:			.word 0x100005c0		# Second row of gold created
	mid_p3:			.word 0x10000840		# Third row of gold created
	mid_p4:			.word 0x10000ac0		# Fourth row of gold created
	mid_p5:			.word 0x10000dc0		# Fifth row of gold created
	explo_right1:		.word 0x100003f8		# First row of explosive placed
	explo_right2:		.word 0x100009f8		# Second row of explosive placed
	explo_right3:		.word 0x10000c78		# Third row of explosive placed
	explo_right4:		.word 0x10000dc8		# Fourth row of explosive placed
...
.text
	...
	create_explosive:
		...
		li	$v0,42  				# 42 is system call code to generate random int
		li	$a1,27 					# $a1 is where you set the upper bound
		syscall     					# your generated number will be at $a0
		move	$t8,$a0					# store random created in t8
		li	$t9,4					# t9 = 4, use for future mutlipiation
		mult	$t9,$t8					# calculate a random memory which on the same height of meidium but random distance
	...
	control:	
		...
		#beq	$t3, 0x00000077, condw			# Check if 'W' key was pressed
	...
	moveDown:
		...
		beq	$s0,0x00ff0000,exit			# TODO: Game Over
